...
describe Serif::FileDigest do
  ...
  describe "#render" do
    it "returns the md5 hex digest of the finally deployed site path" do
      expect(file_digest("test-stylesheet.css").render(@context)).to eq("f8390232f0c354a871f9ba0ed306163c")
    end
    ...
    it "includes a prefix if one is specified" do
      expect(file_digest("test-stylesheet.css prefix:.").render(@context)).to eq(".f8390232f0c354a871f9ba0ed306163c")
    end
